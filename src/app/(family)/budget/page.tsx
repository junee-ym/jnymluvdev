...
import type { Budget, BudgetCategory, BudgetTransaction, TxType } from '@/lib/types'
...
export default async function BudgetPage({
  ...
  const [{ data: categoryRows }, { data: transactionRows }, { data: budgetRows }, { data: trendRows }] = await Promise.all([
    supabase
